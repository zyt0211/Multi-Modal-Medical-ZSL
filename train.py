...
if __name__ == "__main__":
    ...
    lr_decay_type       = 'cos'
    #------------------------------------------------------------------#
    #   save_period     多少个epoch保存一次权值，默认每个世代都保存(已作修改为100)
    #------------------------------------------------------------------#
    save_period         = 100
    #------------------------------------------------------------------#
    ...
    # ------------------------------------------------------#
    datasets_path               = "Data/"
    datasets_train_json_path    = "Data/CheXpert-v1.0-small/train.json"
    datasets_val_json_path      = "Data/CheXpert-v1.0-small/valid.json"
